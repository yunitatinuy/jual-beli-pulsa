...
try:
    ...
    driver.find_element(By.NAME,'no_telp').send_keys('083181531047')
    time.sleep(2)

    driver.find_element(By.NAME,'konfirmasi').click()
    time.sleep(2)

    # pilih metode bayar
    dropdown = Select(driver.find_element(By.NAME,"id_metode_bayar"))

    dropdown.select_by_visible_text("Gopay - 082171479180")
    time.sleep(2)
