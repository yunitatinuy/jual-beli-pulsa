...
<body style="background-color: #F2FFE9;">
    ...
    <section class="jumbotron text-center" style="background-color: #F2FFE9;">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                    <path fill="#71E398" fill-opacity="1"
                ...
                <div class="container1">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col mb-3 ms-4">
                                <div class="card" style="width: 18rem;">
                                    <img src="https://img.freepik.com/premium-vector/concept-delight-thumbs-up_605305-33.jpg?w=740"" class="
                                        card-img-top" alt="">
                                    <div class="card-body">
            ...
            <section id="contact" style="background-color: #F2FFE9;">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                    <path fill="#71E398" fill-opacity="1"
                        d="M0,160L30,154.7C60,149,120,139,180,160C240,181,300,235,360,261.3C420,288,480,288,540,250.7C600,213,660,139,720,128C780,117,840,171,900,208C960,245,1020,267,1080,256C1140,245,1200,203,1260,170.7C1320,139,1380,117,1410,106.7L1440,96L1440,0L1410,0C1380,0,1320,0,1260,0C1200,0,1140,0,1080,0C1020,0,960,0,900,0C840,0,780,0,720,0C660,0,600,0,540,0C480,0,420,0,360,0C300,0,240,0,180,0C120,0,60,0,30,0L0,0Z">
                    </path>
                </svg>
            </section>
            ...
            <!-- logo -->
                <center style="font-weight : bold; background-color : #F2FFE9">QUICK.TOP<br><img src="logo.jpeg" width="60"
                        class="rounded-circle mt-2" alt="...">
                    <br>
                    <div class="py-3"><i class="bi bi-facebook"></i><i class="bi bi-twitter-x px-3"></i><i
