...
<body>
  ...
  <section class="home">
    ...
    <div class="dashboard-content1">
      <div class="dropdown">
        <div class="pengaturan-profil">Pengaturan Profil</div>
        <img src="logo/quicktop.png" alt="">
        <div class="">
          <input type="text" class="dropdown2" name="nama" placeholder="  Name" required>
        </div>
        <div class="">
          <input type="text" class="dropdown2" name="username" placeholder="  Username" required>
        </div>
        <div class="">
          <input type="email" class="dropdown2" name="email" placeholder="  Email" required>
        </div>
        <div class="">
          <input type="password" class="dropdown2" name="password" placeholder="  Password" required>
        </div>
        <div class="">
