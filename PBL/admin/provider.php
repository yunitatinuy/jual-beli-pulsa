...
<div class="row no-gutters mt-5">
  ...
  <div class="col-md-10 p-5 pt-2">
    <h3><i class="fas fa-regular fa-layer-group mr-2"></i> Daftar Provider</h3><hr>
          ...
          ?>
            <tr>
              ...
              <td>
                ...
                <a href="ubah_prv.php" data-toggle="modal" data-target="#editprv<?php echo $data['id_provider'];?>">Edit</a>
...
$query1 = mysqli_query($koneksi, "SELECT * FROM proveder WHERE id_provider='$id_provider'"); while ($data1 = mysqli_fetch_assoc($query1)) {
?>
